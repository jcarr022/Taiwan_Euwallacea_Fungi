...
TreeH <- read.nexus("C:/Users/Joe/OneDrive - email.ucr.edu/Eskalen Lab/My_Projects/Dissertation/Taiwan/Mega Analysis/Manuscript/PACO/tre files/euwallacea_graph.tre") #this function reads Newick trees
TreeP <- read.nexus("C:/Users/Joe/OneDrive - email.ucr.edu/Eskalen Lab/My_Projects/Dissertation/Taiwan/Mega Analysis/Manuscript/PACO/tre files/graph_paco") #for Nexus trees, use read.nexus(file.choose())
...
HP <- as.matrix(read.table("C:/Users/Joe/OneDrive - email.ucr.edu/Eskalen Lab/My_Projects/Dissertation/Taiwan/Mega Analysis/Manuscript/PACO/tre files/graph_euw_table_trans_haplo_2.txt", header=TRUE)) 
...
setwd("C:/Users/Joe/OneDrive - email.ucr.edu/Eskalen Lab/My_Projects/Dissertation/Taiwan/Mega Analysis/Manuscript/PACO/tre files/")
	...
	#2.1 Host and parasite phylogenetic data (should be one of the following):
		#2.1.1 Phylogenetic trees:
TreeH <- read.nexus("C:/Users/Joe/OneDrive - email.ucr.edu/Eskalen Lab/My_Projects/Dissertation/Taiwan/Mega Analysis/Manuscript/PACO/tre files/euwallacea_pape.tre") #this function reads Newick trees
TreeP <- read.nexus("C:/Users/Joe/OneDrive - email.ucr.edu/Eskalen Lab/My_Projects/Dissertation/Taiwan/Mega Analysis/Manuscript/PACO/tre files/pape_paco") #for Nexus trees, use read.nexus(file.choose())
            #Compute patristic distances:
host.D <- cophenetic (TreeH)
para.D <- cophenetic (TreeP)
#
...
#			
	#2.2 ## Read HP: host-parasite association matrix
		#Hosts in rows, parasites in columns. Taxa names are included in the file and should match those in tree, sequence or distance files. 
HP <- as.matrix(read.table("C:/Users/Joe/OneDrive - email.ucr.edu/Eskalen Lab/My_Projects/Dissertation/Taiwan/Mega Analysis/Manuscript/PACO/tre files/pape_euw_table_trans_haplo_2.txt", header=TRUE)) 
        #Sort host and parasite taxa in distance matrices to match the HP matrix:
host.D <- host.D[rownames(HP),rownames(HP)]
para.D <- para.D [colnames(HP), colnames(HP)]
# parafit
